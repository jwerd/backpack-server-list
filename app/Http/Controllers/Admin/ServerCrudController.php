...
class ServerCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('game_id');
        CRUD::column('address');
        CRUD::column('current_player_count');
        CRUD::column('max_player_count');
        CRUD::column('port');
        CRUD::column('query_port');
        CRUD::column('last_queried');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('game_id');
        CRUD::field('address');
        CRUD::field('current_player_count');
        CRUD::field('max_player_count');
        CRUD::field('port');
        CRUD::field('query_port');
        CRUD::field('last_queried');
